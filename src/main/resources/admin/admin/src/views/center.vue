<template>
	<div :style='{"width":"100%","padding":"20px 30px","fontSize":"15px"}'>
		<el-form
			:style='{"padding":"40px 30px","borderColor":"#eee","borderStyle":"solid","borderWidth":"0px 0 0","background":"none"}'
		...
		>
				...
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='cheshang'"  label="车商账号" prop="cheshangzhanghao">
					<el-input v-model="ruleForm.cheshangzhanghao" readonly						placeholder="车商账号" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='cheshang'"  label="车商姓名" prop="cheshangxingming">
					<el-input v-model="ruleForm.cheshangxingming" 						placeholder="车商姓名" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}' v-if="flag=='cheshang'"  label="性别" prop="xingbie">
					<el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
						<el-option
				...
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='cheshang'"  label="手机" prop="shouji">
					<el-input v-model="ruleForm.shouji" 						placeholder="手机" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'   v-if="flag=='cheshang'"  label="身份证" prop="shenfenzheng">
					<el-input v-model="ruleForm.shenfenzheng" 						placeholder="身份证" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}' v-if="flag=='cheshang'" label="资质文件" prop="zizhiwenjian">
					<file-upload
						tip="点击上传资质文件"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}' v-if="flag=='cheshang'" label="头像" prop="touxiang">
					<file-upload
						tip="点击上传头像"
						action="file/upload"
						:limit="3"
...
export default {
	...
	methods: {
		...
		onUpdateHandler() {
			...
			if((!this.ruleForm.cheshangzhanghao)&& 'cheshang'==this.flag){
				this.$message.error('车商账号不能为空');
				return
			}


			if((!this.ruleForm.mima)&& 'cheshang'==this.flag){
				this.$message.error('密码不能为空');
				return
			}

			if((!this.ruleForm.cheshangxingming)&& 'cheshang'==this.flag){
				this.$message.error('车商姓名不能为空');
				return
			}


			if((!this.ruleForm.xingbie)&& 'cheshang'==this.flag){
				this.$message.error('性别不能为空');
				return
			}


			if((!this.ruleForm.shouji)&& 'cheshang'==this.flag){
				this.$message.error('手机不能为空');
				return
			}


			if( 'cheshang' ==this.flag && this.ruleForm.shouji&&(!isMobile(this.ruleForm.shouji))){
				this.$message.error(`手机应输入手机格式`);
				return
			}
			if((!this.ruleForm.shenfenzheng)&& 'cheshang'==this.flag){
				this.$message.error('身份证不能为空');
				return
			}


			if( 'cheshang' ==this.flag && this.ruleForm.shenfenzheng&&(!checkIdCard(this.ruleForm.shenfenzheng))){
				this.$message.error(`身份证应输入身份证格式`);
				return
			}
			if((!this.ruleForm.zizhiwenjian)&& 'cheshang'==this.flag){
