		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.cheshangzhanghao" placeholder="车商账号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
					<div class="lable">车商姓名：</div>
					<el-input v-model="formSearch.cheshangxingming" placeholder="车商姓名" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-button class="list-search-btn" v-if=" true " type="primary" @click="getList(1, curFenlei)">
					查询
				</el-button>
				<el-button class="list-add-btn" v-if="btnAuth('cheshang','新增')" type="primary" @click="add('/index/cheshangAdd')">
					添加
				</el-button>
			</el-form>
			<div class="select2">
			...
			<div class="list">
				...
				<div class="list1 index-pv1">
					<div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
						...
						<div class="name">{{item.cheshangxingming}}</div>
						<div class="time_item">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.cheshangzhanghao != '') searchWhere.cheshangzhanghao = '%' + this.formSearch.cheshangzhanghao + '%';
				if (this.formSearch.cheshangxingming != '') searchWhere.cheshangxingming = '%' + this.formSearch.cheshangxingming + '%';
				if(!this.centerType){
					params['sfsh'] = '是';
				}
				...
				this.$http.get(`cheshang/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/cheshangDetail', query: params});
			},
