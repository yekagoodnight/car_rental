<template>
	<div :style='{"width":"100%","padding":"0 16%","margin":"10px auto","position":"relative","background":"none"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"margin":"0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250123/25ade25938c8405e935839fec0b21be5.png) center center/100% 100%","width":"400px","lineHeight":"80px","fontSize":"30px"}'>我的收藏</div>
