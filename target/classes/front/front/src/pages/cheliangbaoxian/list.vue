		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.baodanbianhao" placeholder="保单编号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
				...
				<el-button class="list-add-btn" v-if="btnAuth('cheliangbaoxian','新增')" type="primary" @click="add('/index/cheliangbaoxianAdd')">
					添加
				</el-button>
			</el-form>
			<div class="select2">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.baodanbianhao != '') searchWhere.baodanbianhao = '%' + this.formSearch.baodanbianhao + '%';
				...
				this.$http.get(`cheliangbaoxian/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/cheliangbaoxianDetail', query: params});
			},
